...
style="display: flex; flex-direction: column; width: 500px; height: 500px;">
	...
	<div style="margin-top: 10px; display: flex; flex-direction: column;">
		...
		<input type="number" min="1" max="25" step="1" id="number">
	</div>
    <div style="margin-top: 10px; display: flex; flex-direction: column;">
    ...
    <div style="margin-top: 10px; display: flex; flex-direction: column;">
        <label class="input" for="feedback">Do you want to leave some words to the artist?</label>
            <textarea style="margin-top: 10px;" rows="10" cols="10" placeholder="Oh, I absolutely..." id="feedback"></textarea>
    </div>
